...
<div class="xp-breadcrumbbar text-center">
  <h4 class="page-title">TrashCategory</h4>
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="#">Admin</a></li>
    <li class="breadcrumb-item active" aria-curent="page">TrashCategory</li>
  </ol>
</div>
          ...
          <tbody class="list">
            <?php  foreach ($data['categories'] as $key) { ?>
              ...
              <tr>
                ...
                <th>
                  <a  onclick="return confirm('Bạn có chắc lấy lại không')" href="index.php?mode=admin&act=edit_status&id=<?= $key['id'] ?>" class="edit" data-toggle="modal">
                    <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
                  </a>
                  <a onclick="return confirm('chac chưa')" href="#" class="delete" data-toggle="modal">
    ...
    <div class="modal fade" tabindex="-1" id="editEmployeeModal" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form action="index.php?mode=admin&act=edit_cate" method="POST" enctype="multipart/form-data">
            <div class="modal-body">
