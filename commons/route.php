...
class Route {
    ...
    //     if ($action === '') return BASE_URL . 'index.php?mode=admin';
    //     $url = BASE_URL . "index.php?mode=admin&act={$action}";
    ...
    // }
    public function getLocateAdmin($action = '', $query = []) {
        if ($action === '') return  'index.php?mode=admin';
        $url =  "index.php?mode=admin&act={$action}";
